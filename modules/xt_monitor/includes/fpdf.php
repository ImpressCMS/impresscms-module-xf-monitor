...
// incluso por claudia
      ob_end_clean();
header("Expires: Mon, 26 Jul 1997 05:00:00 GMT");    // Date in the past  CLAUDIA PEGOU DO HELP PHP
header("Last-Modified: " . gmdate("D, d M Y H:i:s") . " GMT");  // CLAUDIA PEGOU DO HELP PHP

header("Cache-Control: no-store, no-cache, must-revalidate");  // HTTP/1.1  CLAUDIA PEGOU DO HELP PHP
header("Cache-Control: post-check=0, pre-check=0", false);                 // CLAUDIA PEGOU DO HELP PHP
header("Pragma: no-cache");                          // HTTP/1.0            CLAUDIA PEGOU DO HELP PHP
// fim da inclusão
