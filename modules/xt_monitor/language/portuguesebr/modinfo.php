...
define('_MI_XT_MONITOR_HELP','Ajuda');
define('_MI_XT_MONITOR_CONSULTA','Consulta');
define('_MI_XT_MONITOR_CONFMOD','Configurar módulos');
define('_MI_XT_MONITOR_LIMPREG','Limpar Registros');
define('_MI_XT_MONITOR_VERERR','Ver Erros');
define('_MI_XT_MONITOR_CONTARQ','Controle Arquivos');
define('_MI_XT_MONITOR_PARAM','Parâmetros');
define('_MI_XT_MONITOR_GERAHASH','Gerar Hashes');
define('_MI_XT_MONITOR_EXECVERIF','Executar Verificação');

//monitora
define('XT_MONITOR_NOTTABLE','Não ha tabelas para monitorar');

define('XT_MONITOR_MODULONOT','Módulo não precisa monitorar: ');
define('XT_MONITOR_TABLENOT','Tabela não precisa ser monitorada :');

define('XT_MONITOR_ALTEROU',' alterou de: ');
define('XT_MONITOR_PARA',' para: ');
define('XT_MONITOR_ERRSQL',' Erro na SQL ');

define('XT_MONITOR_SQLGRV',' Sql gravada - módulo: ');
define('XT_MONITOR_TABLE',' tabela: ');
...
// Admin
define('_AM_XT_MONITOR_PARAM_NOT_CAD','Parâmetros não cadastrados, vá na aba Parâmetros, para defini-los');

define('_AM_XT_MONITOR_NOTCONF','XT_MONITOR Não está configurado corretamente,  veja  no Help: Como Ativar ');


define('_AM_XT_MONITOR_TEMACONSULTA','Consulta de logs de acessos   -  Informe dados para filtrar ');

define('_AM_XT_MONITOR_SELCAMPOS','Selecione os campos desejados');

define('_AM_XT_MONITOR_MARCALL','Marca/Desmarca Todos');

define('_AM_XT_MONITOR_LOCSAI','Local de saída');
define('_AM_XT_MONITOR_TELA','Tela');
define('_AM_XT_MONITOR_PDF','Impressora (pdf)');
define('_AM_XT_MONITOR_CSV','Arquivo (csv) ');
define('_AM_XT_MONITOR_XLS','Excell (xls) ');
define('_AM_XT_MONITOR_ORIENT','Orientação da Folha: (pdf)');

define('_AM_XT_MONITOR_VERT','Vertical ');
define('_AM_XT_MONITOR_HORIZ','Horizontal ');
define('_AM_XT_MONITOR_FORMPAPER','Selecione o formato do papel (pdf)');

define('_AM_XT_MONITOR_REGPPAGE','Registros por página:');

define('_AM_XT_MONITOR_PERIODO','Periodo');
define('_AM_XT_MONITOR_INICIO','Início');
define('_AM_XT_MONITOR_FIM','Fim');
define('_AM_XT_MONITOR_ATE',' até ');
